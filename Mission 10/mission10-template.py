...
# assuming balanced. if not balanced O(n)
...
# Time complexity of flatten: O(n log n)
# O(n + 2*(n/2) + 4*(n/4) + ... log n times)
# assuming balanced. if not balanced O(n^2)
...
# Time complexity of sort_it: O(n log n)
