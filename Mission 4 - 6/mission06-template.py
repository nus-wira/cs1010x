...
#  2) Every level of gosper_curve will call the rotate function. While rotate calls curve(t) once, joe_rotate will do this twice. This causes the call to double every level causing the time to go exponential.
